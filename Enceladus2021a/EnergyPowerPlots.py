...
# EPS.make_MGEContourPlot(CO2origin='HTHeatingSalts', save='energyplottest_endmembersalt.pdf', show=False, pHax=True, pHbars=True, quotienttype='salty_endmember')
...
# EPS.make_PSContourPlot(CO2origin='HTHeatingSalts', save='powerplottest2.pdf', show=False, mesh=True)
...
# EPS.PSunc_plot(CO2origin='HTHeatingSalts', mesh=True, save='figs/PowerSupply_comp_k05.pdf', nATP=0.5)
# EPS.PSunc_plot(CO2origin='HTHeatingSalts', mesh=True, save='figs/PowerSupply_comp_k15.pdf', nATP=1.5)
# EPS.PSunc_plot(CO2origin='HTHeatingSalts', mesh=True, save='figs/PowerSupply_comp_k025.pdf', nATP=0.25)
# EPS.PSunc_plot(CO2origin='HTHeatingSalts', mesh=True, save='figs/PowerSupply_comp_k200.pdf', nATP=2.0)
